...
@section('content')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            <h2 class="text-xl font-bold text-gray-800 mb-4">Monthly Agent Review Filters</h2>
        ...
        <!-- Dashboard Container -->
        <div id="dashboardContainer" class="hidden max-w-5xl mx-auto bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden">
            <!-- Header -->
            ...
            <div class="bg-amber-50 border-b border-amber-200 px-6 py-3 text-sm">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    <div>
                        <span class="text-amber-700">Agent:</span> <span class="font-bold text-gray-900" id="lblAgentName">Agent Name (Code)</span>
                    </div>
                    <div>
                        <span class="text-amber-700">Routes:</span> <span class="font-bold text-gray-900" id="lblRoutes">Routes List</span>
                    </div>
                    <div>
                        <span class="text-amber-700">Monthly Target:</span> <span class="font-bold text-gray-900" id="lblMonthlyTarget">Rs. 0</span>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="metric-card large-metric-card flex flex-col justify-between text-right">
                        ...
                        <div class="text-sm text-gray-500 mt-2" id="valTargetRemark">Target missed by 0% — discuss in meeting</div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
                    ...
                    <div>
                        ...
                        <div class="text-xs text-gray-500 italic mt-2">Pattern: compliance and sales dipped mid-month — review route discipline.</div>
                    </div>
                ...
                <div class="metric-card mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-3 text-sm">
                            <div><span class="text-gray-600">Invoiced value:</span> <strong id="valComInvoiced">Rs. 0</strong> &mdash; <span class="text-gray-600">Returns:</span> <strong id="valComReturns">Rs. 0</strong></div>
                            <div><span class="text-gray-600">Net sales:</span> <strong class="text-gray-900 text-base" id="valComNetSales">Rs. 0</strong></div>
                            <div><span class="text-gray-600">Invoicing commission (<span id="valComInvRate">0</span>% x net):</span> <strong class="text-gray-900" id="valComInvAmt">Rs. 0</strong></div>
                            <div><span class="text-gray-600">Target bonus:</span> <strong id="valComBonusAmt" class="text-rose-600">Rs. 0 — not qualified</strong></div>
                            <div class="pt-2 border-t border-gray-100"><span class="text-gray-600 font-bold">Total payable:</span> <strong class="text-amber-700 text-lg" id="valComTotal">Rs. 0</strong></div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-2">
                                Bonus is all-or-nothing: 100% required at every level. Missing target by <strong class="text-gray-800" id="valMissTargetAmt">Rs. 0</strong> cost the full bonus.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-2">
                    ...
                    <div class="metric-card">
                        ...
                        <div class="space-y-3 text-sm">
                            <div><span class="text-gray-600">Closing dues:</span> <strong class="text-gray-900" id="valCredClosing">Rs. 0</strong> <span class="text-gray-400 mx-2">|</span> <span class="text-gray-600">Utilization:</span> <strong class="text-amber-600" id="valCredUtil">0%</strong></div>
                            <div class="pt-2">
                                <span class="text-gray-600">Ageing — Current:</span> <strong class="text-gray-900" id="valCredCur">Rs. 0</strong> 
                                <span class="text-gray-400 mx-1">•</span> <span class="text-gray-600">1-30d:</span> <strong class="text-gray-900" id="valCred30">Rs. 0</strong>
                            </div>
                            <div>
                                <span class="text-gray-600">31-60d:</span> <strong class="text-amber-600" id="valCred60">Rs. 0</strong> 
                                <span class="text-gray-400 mx-1">•</span> <span class="text-gray-600">60d+:</span> <strong class="text-rose-600" id="valCred60Plus">Rs. 0</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="metric-card flex flex-col justify-between">
                        <h3 class="section-title"><span id="lblNextMonth">Next Month</span> Target (entered by management — sign-off in meeting)</h3>
                        <div class="space-y-4 mt-2">
                            <div class="text-sm"><span class="text-gray-600">Proposed target:</span> <strong class="text-gray-900">________________________</strong></div>
            ...
            <div class="bg-gray-50 border-t border-gray-100 text-xs text-gray-400 p-3 text-right">
                Dimuthu Bakers v2.0.1 — Report B — Monthly Agent Page
            </div>
        </div>
    </div>
