...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            <!-- Agent Picker -->
            <div class="relative">
                <select id="summary-agent" class="form-select pl-9 text-slate-500 hover:text-slate-600 font-medium focus:border-slate-300 w-full md:w-60 bg-white border-slate-200 rounded-lg shadow-sm px-3 py-2 appearance-none">
            ...
            <!-- Date Picker -->
            <div class="relative">
                <input id="summary-date" class="form-input pl-9 text-slate-500 hover:text-slate-600 font-medium focus:border-slate-300 w-full md:w-48 bg-white border-slate-200 rounded-lg shadow-sm px-3 py-2" type="date" />
                <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
            ...
            <button id="search-btn" class="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg px-4 py-2 font-medium shadow-sm flex items-center gap-2 transition-colors">
    ...
    <div id="summary-content" class="hidden space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-xl border border-slate-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center py-2 border-b border-slate-100">
                        <div class="w-8 h-8 rounded bg-emerald-50 text-emerald-500 flex items-center justify-center mr-3"><i class="bi bi-cash"></i></div>
                        <span class="text-slate-600 flex-1">Cash</span>
                        <span class="font-semibold text-slate-800" id="pay-cash">Rs. 0.00</span>
                    </div>
                    <div class="flex items-center py-2 border-b border-slate-100">
                        <div class="w-8 h-8 rounded bg-blue-50 text-blue-500 flex items-center justify-center mr-3"><i class="bi bi-credit-card"></i></div>
                        <span class="text-slate-600 flex-1">Credit</span>
                        <span class="font-semibold text-slate-800" id="pay-credit">Rs. 0.00</span>
                    </div>
                    <div class="flex items-center py-2 border-b border-slate-100">
                        <div class="w-8 h-8 rounded bg-amber-50 text-amber-500 flex items-center justify-center mr-3"><i class="bi bi-journal-check"></i></div>
                        <span class="text-slate-600 flex-1">Cheque</span>
                        <span class="font-semibold text-slate-800" id="pay-cheque">Rs. 0.00</span>
                    </div>
                    <div class="flex items-center py-2 border-b border-slate-100">
                        <div class="w-8 h-8 rounded bg-purple-50 text-purple-500 flex items-center justify-center mr-3"><i class="bi bi-bank"></i></div>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200 mt-6">
            <header class="px-5 py-4 border-b border-slate-100 flex justify-between items-center">
                ...
                <span class="text-xs bg-slate-100 text-slate-500 font-medium px-2.5 py-1 rounded-full" id="load-count">0 Loads</span>
            </header>
            <div class="p-3">
    ...
    <div id="load-modal" class="fixed inset-0 bg-slate-900/60 z-[100] hidden flex items-center justify-center p-4 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden transform transition-all">
            <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                ...
                <button id="close-modal" class="text-slate-400 hover:text-slate-600 transition-colors p-1 rounded-md hover:bg-slate-100">
