    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            <button onclick="switchTab('product-types')" id="tab-btn-product-types"
                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors border-indigo-500 text-indigo-600 hidden">
                Product Types
            </button>
            <button onclick="switchTab('brands')" id="tab-btn-brands"
                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hidden">
                Brands
            </button>
