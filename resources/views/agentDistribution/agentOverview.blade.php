                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div id="headerSubtitle" class="flex items-center gap-2">
                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Command
                                Center</span>
                        </div>
                    </div>
                </div>
        ...
        <div id="mainDashboard" class="hidden transition-all duration-500 opacity-0 transform translate-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-emerald-600">
                                    <i class="bi bi-graph-up-arrow text-xl"></i>
                                </div>
                                <span
                                    class="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full uppercase">MTD
                                    Sales</span>
                            </div>
                            <p id="statTotalSales" class="text-2xl font-bold text-gray-800 tracking-tight">Rs. 0.00</p>
                            <p class="text-[10px] font-semibold text-gray-400 mt-1 uppercase tracking-widest">Accumulated
                                Monthly</p>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span id="statCreditLimit"
                                    class="text-[10px] font-bold text-rose-600 bg-rose-50 px-2.5 py-1 rounded-full uppercase">Limit:
                                    Rs. 0</span>
                            </div>
                            <p id="statOutstanding" class="text-2xl font-bold text-rose-600 tracking-tight">Rs. 0.00</p>
                            <p class="text-[10px] font-semibold text-gray-400 mt-1 uppercase tracking-widest">Current Dues</p>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-indigo-600">
                                    <i class="bi bi-cash-coin text-xl"></i>
                                </div>
                            </div>
                            <p id="statCollections" class="text-2xl font-bold text-gray-800 tracking-tight">Rs. 0.00</p>
                            <p class="text-[10px] font-semibold text-gray-400 mt-1 uppercase tracking-widest">Total Collections
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span id="statRoutesCount"
                                    class="text-[10px] font-bold text-amber-600 bg-amber-50 px-2.5 py-1 rounded-full">0
                                    Routes</span>
                            </div>
                            <p id="statRecovery" class="text-2xl font-bold text-gray-800 tracking-tight">0%</p>
                            <p class="text-[10px] font-semibold text-gray-400 mt-1 uppercase tracking-widest">Operational
                                Success</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-wrap items-center gap-2 p-4 bg-gray-50/50 border-b border-gray-100">
                            <button onclick="switchTab('ops')" id="tab-ops"
                                class="tab-btn active px-6 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-2">
                                <i class="bi bi-truck"></i> Daily Operations
                            </button>
                            <button onclick="switchTab('fleet')" id="tab-fleet"
                                class="tab-btn px-6 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-2">
                                <i class="bi bi-people"></i> Fleet & Team
                            </button>
                            ...
                            <button onclick="switchTab('network')" id="tab-network"
                                class="tab-btn px-6 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-2">
                                <i class="bi bi-globe"></i> Market Network
                            </button>
                        </div>
                        ...
                        <div class="flex-1 p-8">
                            ...
                            <div id="pane-ops" class="tab-pane active animate-fadeIn">
                                <div class="mb-6 flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-100 px-3 py-1 rounded-full">Last
                                        10 Records</span>
                                </div>
                                    ...
                                    <table class="w-full text-left">
                                        <thead>
                                            <tr class="border-b border-gray-300">
                                                <th
                                                    class="pb-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest pl-4">
                                                    Date / Load ID</th>
                                                <th class="pb-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                    Route / Vehicle</th>
                                                <th
                                                    class="pb-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center">
                                                    Summary</th>
                                                <th
                                                    class="pb-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-right pr-4">
                                                    Action</th>
                                            </tr>
                                        </thead>
            ...
            <div id="loadingOverlay"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-indigo-500 font-bold tracking-widest uppercase text-[10px]">Synchronizing Field Data...</p>
                </div>
            </div>

            <!-- MODAL: DAILY LOAD DETAILS (Tailwind Implementation) -->
            <div id="dailyLoadModal"
                class="hidden fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0 bg-gray-900/40 backdrop-blur-sm animate-fadeIn">
                    ...
                    <div
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                ...
                                <div class="lg:col-span-4 space-y-8">
                                    <div class="bg-indigo-50/50 p-6 rounded-[2rem] border border-indigo-100/50">
                                        <h6
                                            class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mb-4 flex items-center gap-2">
                                    ...
                                    <div class="p-6 bg-gray-50 rounded-[2rem]">
                                        <h6 class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Summary
                                            Notes</h6>
                                ...
                                <div class="lg:col-span-8 space-y-6">
                                    <h6
                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-2 flex items-center gap-2">
                        ...
                        <div class="border-t border-gray-100 p-8 bg-gray-50/50 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Record Integrity
                                    Verified</span>
                            </div>
                            <button type="button" onclick="closeLoadModal()"
                        ...
                        <div class="modal-body p-8 max-h-[80vh] overflow-y-auto no-scrollbar">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div class="bg-blue-50/50 p-6 rounded-[2rem] border border-blue-100/50">
                                    <h6 class="text-[10px] font-bold text-blue-600 uppercase tracking-widest mb-3">Request Info</h6>
                                    <div class="space-y-2">
                                        <div class="flex justify-between items-center bg-white/60 p-2 rounded-xl border border-blue-50">
                                        ...
                                        <div class="flex justify-between items-center bg-white/60 p-2 rounded-xl border border-blue-50">
                                            ...
                                            <span id="modalOrderStatusText" class="text-[9px] font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100 uppercase uppercase">Approved</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-indigo-50/50 p-6 rounded-[2rem] border border-indigo-100/50">
                                    <h6 class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mb-3">Customer Entity</h6>
                                    <div class="p-3 bg-white/60 rounded-2xl border border-indigo-50">
                                        <p class="text-sm font-bold text-gray-800 mb-0.5" id="modalOrderCustomer">Customer Name</p>
                                        <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Distribution Network Partner</p>
                                    </div>
                                </div>
                            </div>

                            <div class="space-y-6">
                                <h6 class="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-2 flex items-center gap-2">
            ...
            function renderDashboard(data) {
                ...
                tableBody.innerHTML = data.dailyLoads.map(l => `
                    <tr class="hover:bg-gray-100/50 transition-all border-b border-gray-100">
                        <td class="py-5 pl-4">
                            ...
                            <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">ID: #LOAD-${l.id}</p>
                        </td>
                        <td>
                            <p class="text-xs font-bold text-gray-700">${l.route?.route_name || 'Generic Route'}</p>
                            <p class="text-[9px] font-bold text-indigo-400 uppercase tracking-widest italic">${l.vehicle?.vehicle_number || 'Dispatching'}</p>
                        </td>
                        <td class="text-center">
                            <span class="text-[10px] font-bold text-gray-600 bg-gray-100 px-3 py-1 rounded-full border border-gray-200">
                                ${l.invoices.length} Market Visits
                            </span>
                        </td>
                        <td class="text-right pr-4">
                            <button onclick="openLoadModal(${l.id})" class="px-5 py-2 bg-white text-indigo-600 border border-indigo-500 rounded-xl text-[10px] font-bold hover:bg-indigo-600 hover:text-white transition-all shadow-sm">
                                View Analysis
                            </button>
                        </td>
                    </tr>
                ...
                fleetGrid.innerHTML = team.map(t => `
                    <div class="bg-gray-50/50 p-6 rounded-[2rem] border border-${t.color}-500 flex items-center gap-5 group hover:bg-white hover:shadow-lg transition-all">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">${t.label}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-[2rem] border border-indigo-300 flex items-center justify-between hover:border-indigo-500 transition-all shadow-sm">
                        <div class="flex items-center gap-6 min-w-0">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-[9px] font-bold text-gray-400 italic">${new Date(o.created_at).toLocaleString()}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-8 px-8 border-x border-gray-50 hidden md:flex">
                             <div class="text-center">
                                <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">SKU Type</p>
                                <p class="text-[10px] font-bold text-indigo-600">${o.order_products.length} Items</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <span class="text-[9px] font-bold uppercase tracking-widest bg-emerald-50 text-emerald-600 px-4 py-1 rounded-full border border-emerald-100">${getStatusLabel(o.status)}</span>
                            <button onclick="openOrderModal(${o.id})" class="px-5 py-2 bg-white text-indigo-600 border border-indigo-500 rounded-xl text-[10px] font-bold hover:bg-indigo-600 hover:text-white transition-all shadow-sm">
                                View Order
                            </button>
                        </div>
                    </div>
                ...
                networkGrid.innerHTML = data.customers.map(c => `
                     <div class="bg-white p-6 rounded-[2rem] border border-blue-500 text-center hover:shadow-xl transition-all group">
                        ...
                        <h5 class="text-[13px] font-bold text-gray-800 mb-1 truncate">${c.business_name || c.customer?.name}</h5>
                        <p class="text-[9px] font-bold text-gray-400 truncate mb-4 italic">${c.address || 'Field Mapping Active'}</p>
            ...
            function openLoadModal(loadId) {
                ...
                dispatchItems.innerHTML = load.items.map(item => `
                    <div class="bg-white p-4 rounded-2xl border border-indigo-50 shadow-sm flex items-center justify-between group hover:border-indigo-200 transition-all">
                        <span class="text-xs font-bold text-indigo-900 truncate pr-4">${item.product?.product_name || 'Generic SKU'}</span>
                        <span class="text-[10px] font-bold bg-amber-50 text-amber-600 px-2.5 py-1 rounded-lg border border-amber-100">${parseInt(item.loaded_qty)} Units</span>
                    </div>
                `).join('') || '<p class="text-[10px] text-gray-400 italic p-4 text-center">No dispatch items logged</p>';

                // Pop Invoices
                const invoiceGrid = document.getElementById('modalMarketInvoices');
                invoiceGrid.innerHTML = load.invoices.map(inv => `
                    <div class="bg-white p-5 rounded-3xl border border-gray-100 hover:shadow-lg hover:border-emerald-100 transition-all relative overflow-hidden group/inv">
                        <div class="relative z-10">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <p class="font-bold text-gray-800 text-[13px] tracking-tight leading-none mb-1">${inv.business?.business_name || 'Direct Client'}</p>
                                    <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">${inv.invoice_number}</p>
                                </div>
                                <p class="text-xs font-bold text-emerald-600">Rs. ${parseFloat(inv.net_price).toLocaleString()}</p>
                            </div>

                            <div class="space-y-1.5 pt-4 border-t border-gray-50">
                                ${inv.items.map(ii => `
                                    <div class="flex justify-between items-center text-[10px]">
                                        <span class="text-gray-500 font-semibold truncate pr-4">${ii.product?.product_name || 'SKU'}</span>
                                ...
                                ${inv.new_return_items && inv.new_return_items.length > 0 ? `
                                     <div class="mt-4 pt-3 border-t border-dashed border-gray-100 space-y-1">
                                        <p class="text-[8px] font-bold text-rose-500 uppercase tracking-widest mb-1">Returns Applied</p>
                ...
                `).join('') || '<div class="col-span-2 py-12 text-center border-2 border-dashed border-gray-50 rounded-[2rem]"><p class="text-[10px] text-gray-300 font-bold uppercase tracking-widest">No Invoice Data Logged</p></div>';
                ...
                orderItems.innerHTML = order.order_products.map(item => `
                    <div class="bg-white p-4 rounded-2xl border border-indigo-50 shadow-sm flex items-center justify-between group hover:border-indigo-200 transition-all">
                        <div class="flex flex-col min-w-0 pr-4">
                            <span class="text-xs font-bold text-indigo-900 truncate">${item.product_item?.product_name || 'Generic SKU'}</span>
                            <span class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">${item.product_item?.variation_value || 'Direct Unit'}</span>
                        </div>
                        <span class="text-[10px] font-bold bg-amber-50 text-amber-600 px-2.5 py-1 rounded-lg border border-amber-100 shrink-0">
                            ${parseInt(item.quantity)} Units
                        </span>
                    </div>
                `).join('') || '<p class="text-[10px] text-gray-400 italic p-4 text-center">No requested items found</p>';
